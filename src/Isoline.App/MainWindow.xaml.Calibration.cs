...
namespace Isoline
{
	public partial class MainWindow
	{
		private void ButtonReadCalibration_Click(object sender, RoutedEventArgs e)
		{
			...
			// Currently Isoline parses them in GrblSettingsWindow, but we might just hook into the Machine's log or global settings if they exist.
			// Actually, Isoline's core might not store the $ variables in a public dictionary. Let's just ask the user to input them.
