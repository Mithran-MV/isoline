...
namespace Isoline
{
	public partial class MainWindow : Window, INotifyPropertyChanged
	{
		...
		private void UnhandledException(object sender, UnhandledExceptionEventArgs ea)
		{
			...
			try
			{
				System.IO.File.WriteAllText("Isoline_Crash_Log.txt", info);
			}
			catch { }
		...
		private void ButtonSaveViewport_Click(object sender, RoutedEventArgs e)
		{
			...
			coords.AddRange(viewport.Camera.Position.ToVector3().Array);
			coords.AddRange(viewport.Camera.LookDirection.ToVector3().Array);
