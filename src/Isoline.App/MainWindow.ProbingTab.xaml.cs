...
namespace Isoline
{
	partial class MainWindow
	{
		...
		{
			HeightMapVisuals.GetPreviewModel(NewHeightMapDialog.Min, NewHeightMapDialog.Max, NewHeightMapDialog.GridSize, ModelHeightMapBoundary, ModelHeightMapPoints);
		}
